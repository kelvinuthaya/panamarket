  ...
  return (
    <div className="bg-bitume text-white min-h-[100dvh] lg:h-[100dvh] lg:overflow-hidden">
      ...
      {/* ══════════════════════════ MODE POS (lg:) — 2 colonnes ══════════════════════════
          Gauche : contrôles (période, date, stats, CA) + export. Droite : liste,
          scroll interne (768px de haut oblige). Mêmes données/handlers que le mode mobile. */}
      <div className="hidden lg:flex h-full">
        ...
        <div className="w-[380px] shrink-0 h-full overflow-y-auto pos-scroll border-r border-white/10 px-4 py-6">
          ...
          <div className="mb-5 bg-bitume-2 border border-white/5 rounded-2xl p-3 flex items-center gap-3">
            ...
            <div className="flex-1">
              <label htmlFor="date-journee-pos" className="tag-street text-zinc-500 block mb-1">
                DATE DE RÉFÉRENCE
              </label>
              <input
                id="date-journee-pos"
